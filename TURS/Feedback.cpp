...
//Methods
Feedback* FeedbackList::CreateNewNode(string feedbackID, string custEmail, string universityID, string feedback, string reply)
{
...
void FeedbackList::InsertToEndList(string feedbackID, string custEmail, string universityID, string feedback, string reply)
{
