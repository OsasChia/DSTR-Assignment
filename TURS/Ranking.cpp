...
void RankingList::InsertToEndList(string universityID, double ArScore, double ArRank, double ErScore, double ErRank, double FsrScore, double FsrRank, double CpfScore, double CpfRank, double IfrScore, double IfrRank, double IsrScore, double IsrRank, double IrnScore, double IrnRank, double GerScore, double GerRank, double ScoreScaled)
{
	//call the create function to build a new single node first
	Ranking* newnode = CreateNewNode(universityID, ArScore, ArRank, ErScore, ErRank, FsrScore, FsrRank, CpfScore, CpfRank, IfrScore, IfrRank, IsrScore, IsrRank, IrnScore, IrnRank, GerScore, GerRank, ScoreScaled);
...
//	RankingList rankingList;
//	//Define variable
//	string universityID, ArScore, ArRank, ErScore, ErRank, FsrScore, FsrRank, CpfScore, CpfRank, IfrScore, IfrRank, IsrScore, IsrRank, IrnScore, IrnRank, GerScore, GerRank, ScoreScaled;
//	//input file
...
//		}
//
//		rankingList.InsertToEndList(universityID, stod(ArScore), stod(ArRank), stod(ErScore), stod(ErRank), stod(FsrScore), stod(FsrRank), stod(CpfScore), stod(CpfRank), stod(IfrScore), stod(IfrRank), stod(IsrScore), stod(IsrRank), stod(IrnScore), stod(IrnRank), stod(GerScore), stod(GerRank), stod(ScoreScaled));
//	}
//	file.close();
//
